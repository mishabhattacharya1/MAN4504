...
st.markdown("<p style='text-align: center; font-size: 16px;'>Welcome! This dashboard is an educational toolkit designed to strengthen your operations management skillset. It features four interactive models based on material from Chapter 12 (Inventory Management), Chapter 8 (Revenue Management), Chapter 13 (Aggregate Planning), and Chapter 3 (Project Management). Each model includes detailed explanations, relevant formulas, visualizations, and interactive prompts that allow you to define key variables and simulate data-driven decision-making. The methodologies used are directly derived from course concepts and are intended to reinforce understanding through hands-on application.</p>", unsafe_allow_html=True)
